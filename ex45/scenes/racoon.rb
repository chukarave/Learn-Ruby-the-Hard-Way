module Racoon 
  def self.enter()
    ...
    puts 'The racoon startles you as it suddenly speaks, saying "Welcome bypasser. You must answer one of these questions correctly to continue."'
        
    until Trivia::run true
